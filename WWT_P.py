...
schedule.every().monday.at("10:47").do(_CartridgeFilter(),'It is 9:00 on a Regular Treatment Day')
...
schedule.every().saturday.at("9:00").do(_RegularDay,'It is 9:00 on a Regular Treatment Day')
