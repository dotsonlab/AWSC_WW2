...
schedule.every().monday.at("10:49").do(_CartridgeFilter())
schedule.every().tuesday.at("9:00").do(_WasteDay,)
schedule.every().wednesday.at("9:00").do(_RegularDay)
schedule.every().thursday.at("9:00").do(_RegularDay)
schedule.every().friday.at("9:00").do(_RegularDay)
schedule.every().saturday.at("9:00").do(_RegularDay)
schedule.every().sunday.at("9:00").do(_RegularDay)
